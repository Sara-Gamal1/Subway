...
void main(){
    ...
    /*
    1-make tex_coord from 0-2 then subtract 1
    2-get the squared length of the 2D pixel location in NDC space by dotting the tex_coord with itself
    3-perform calculation
    */
    vec2 ndc=(tex_coord*2)-1;
    frag_color/=(1.+dot(ndc,ndc));
}